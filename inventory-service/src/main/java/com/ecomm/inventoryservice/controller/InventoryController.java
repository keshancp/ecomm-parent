...
public class InventoryController {
	...
	public ECommInventoryResponse isInStock(@RequestParam List<String> itemCodeList, @RequestParam String traceId) throws ECommInventoryException {
		List<InventoryDto> inventoryDtoList = inventoryServiceImpl.isInStock(itemCodeList,traceId);
		
		if(inventoryDtoList.size() != itemCodeList.size()) {
